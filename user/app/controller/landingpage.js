...
const { filter_user_hospital_model, userretrievesinglehospitalModel, userlandingpagelModel } = require("../model/landingpage");
...
const user_hospital_controller = async (req, res, next) => {
    try {
      const {
        name , ownership , facility_type , ward , type , category
      } = req.body;
      var query = { $and: [] };
...
module.exports = {
    user_hospital_controller , userretrievesinglehospiotalController , userlandingpageController
}